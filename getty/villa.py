...
def checkout_build(proj_dir, commit_hash):
    ...
    print "villa checkoutbuild: sys call git checkout"+ str((time.time() - start))
    start = time.time()
    os.sys_call("mvn clean")
    print "villa checkoutbuild: sys call mvn clean"+ str((time.time() - start))
    start = time.time()
    ...
    print "villa checkoutbuild: sys call mvn test-compile"+ str((time.time() - start))
...
def visit(villa_path, pwd, proj_dir, go, prev_hash, post_hash, pkg_prefix="-"):
    ...
    print "villa visit:: git diff "+ str((time.time() - start))
    '''
    ...
    print "villa visit::: checkoutbuild proj dir, prev hash"+ str((time.time() - start))
    ...
    print "villa visit::: various ex.read_str_from"+ str((time.time() - start))
    #     # DEBUG ONLY
    ...
    print "villa visit::: checkoutbuild proj dir, post hash"+ str((time.time() - start))
    ...
    print "villa:: numerous ex.read_str_from"+ str((time.time() - start))
    #     # DEBUG ONLY
    ...
    print "villa:: clear_temp_checkout"+ str((time.time() - start))
